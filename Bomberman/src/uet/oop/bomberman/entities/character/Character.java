...
public abstract class Character extends AnimatedEntitiy {
	...
	protected Board _board; // ban do
	protected int _direction = -1;	//huong di
	protected boolean _alive = true;	//con song khong
	protected boolean _moving = false;	//danh dau de hien thi nhan vat
