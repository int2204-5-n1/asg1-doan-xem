...
public class Bomber extends Character {
    ...
    private List<Bomb> _bombs;  //list bom
    protected Keyboard _input;  //Nhan vao ky tu de di chuyen nhan vat
...
//        int xScroll = Screen.calculateXOffset(_board, this);
        //TODO: Thiết lập giữ nguyên màn hình
    ...
    public boolean collide(Entity e) {
        ...
        if(e instanceof Flame){
            kill();
            return false;   //Chạm phải Flame thì bomber "bay màu"
        }
        if(e instanceof Enemy){
            kill();
            return true;    //Chạm phải enemy thì bomber "bay màu"
        }
        return true;
    }
