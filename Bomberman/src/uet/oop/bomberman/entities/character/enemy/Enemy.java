...
public abstract class Enemy extends Character {
	...
	public boolean collide(Entity e) {
		...
		if(e instanceof Flame) {
			kill();
			return false;	//nếu va phải Flame thì cho enemy "bay màu" (return false;)
		}
		if(e instanceof Bomber) {
			kill();
			return true;	//nếu va phải Bomber thì cho Bomber "bay màu" (return true;)
		}
		return true;	//Còn nếu không va chạm vẫn chạy bình thường
	}
