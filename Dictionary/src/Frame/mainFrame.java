...
public class mainFrame extends javax.swing.JFrame {
    ...
    public void setupJlist() {
        if (select == 0) {
            ...
            for(String key: dic1.getKeys1())
                list.addElement(key);
            jList1.setModel(list);
        } else if (select == 1) {
            DefaultListModel list = new DefaultListModel();
            for( String key: dic2.getKeys2())
                list.addElement(key);
            jList1.setModel(list);
        }
    }
    ...
    //Tạo sự kiện khi nhấm button add
    ...
    //Tạo sự kiện khi nhấn button edit
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        if (jList1.getSelectedValue() == null) {
            JOptionPane.showMessageDialog(null, "Choose a word to edit!!"); //Thông báo cần chọn từ để sửa
        } else {
            fEdit.setVisible(true);
            fEdit.setLocation(getX() + 200, getY() + 150);
            fEdit.jTextField1.setText(jList1.getSelectedValue());
            fEdit.jTextPane1.setContentType("text/html");   // định dạng html cho textPane
            if (select == 0) {
    ...
    //Set up cho Jlist khi vừa mở chương trình
    ...
    //In ra meaning cho từ được chọn
    ...
    //Xử lý để setup cho jList mỗi lần search từ
    private void SearchWordKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SearchWordKeyReleased
        if (select == 0) {
            ArrayList<String> newList;
            DefaultListModel<String>list = new DefaultListModel<>();
            if (SearchWord.getText().trim().isEmpty()) {
                newList = new ArrayList(dic1.getKeys1());
            } else {
                newList = s.searchKey(SearchWord.getText(), dic1.getKeys1());
            }
            ...
            DefaultListModel<String>list = new DefaultListModel<>();
            if (SearchWord.getText().trim().isEmpty()) {
                newList = new ArrayList(dic2.getKeys2());
            } else {
                newList = s.searchKey(SearchWord.getText(), dic2.getKeys2());
            }
            for (String key : newList) {
                list.addElement(key);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                if ("JTattoo-1.6.11".equals(info.getName())) {
